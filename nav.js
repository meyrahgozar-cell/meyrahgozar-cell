...
(function () {
  ...
  async function hqlLoadCoachWord() {
    try {
      ...
      /* ۳ ثانیه باز، بعد نرم بسته — با کلیک مثل قبل باز/بسته می‌شود */
      wrap.classList.add("is-open");
      var autoCloseTimer = setTimeout(function () {
        if (wrap && !wrap._userHeldOpen) {
